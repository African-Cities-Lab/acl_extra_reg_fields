...
"""
acl_extra_reg_fields documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'acl_extra_reg_fields',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/African-Cities-Lab/acl_extra_reg_fields",
...
#
# html_title = 'acl_extra_reg_fields v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'acl_extra_reg_fields'),
                os.path.join(root_path, 'acl_extra_reg_fields/migrations')])
