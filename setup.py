#!/usr/bin/env python
"""
Package metadata for acl_extra_reg_fields.
"""
import os
import re
import sys
...
VERSION = get_version('acl_extra_reg_fields', '__init__.py')
...
setup(
    ...
    author_email='abdul.muqadim@arbisoft.com',
    url='https://github.com/African-Cities-Lab/acl_extra_reg_fields',
    packages=find_packages(
        include=['acl_extra_reg_fields', 'acl_extra_reg_fields.*'],
        exclude=["*tests"],
    ),
    entry_points={
        "lms.djangoapp": [
            "acl_extra_reg_fields = acl_extra_reg_fields.apps:AclExtraRegFieldsConfig",
        ],
        "cms.djangoapp": [
            "acl_extra_reg_fields = acl_extra_reg_fields.apps:AclExtraRegFieldsConfig",
        ],
